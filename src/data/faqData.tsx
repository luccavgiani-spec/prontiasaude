...
export const faqData: FAQ[] = [
  ...
  },
  {
    ...
    answer: (
      <p>
        Não há coparticipação nas consultas online, o pagamento é apenas o valor mensal do plano. Também não há carência para consultas de telemedicina - você pode usar imediatamente após contratar.
      </p>
    )
  },
  {
