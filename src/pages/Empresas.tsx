...
const Empresas = () => {
  ...
  const colaboradorAdvantages = ["Consultas 24 horas de onde estiver", "+10 especialidades para agendar", "Acompanhamento de doenças crônicas", "Apoio psicológico e emocional quando precisar", "Palestras, vídeos e respiração para saúde mental", "Descontos em exames e medicações"];
