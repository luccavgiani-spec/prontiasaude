...
const WA_LINK = "https://wa.me/5511933359187?text=Quero%20agendar%20um%20exame!";
const WhatsAppIcon = () => <svg className="w-4 h-4 mr-2" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
export default function ConfirmacaoExame() {
  ...
  return <div className="min-h-screen bg-gradient-to-b from-primary/5 to-background py-16">
            ...
            <div className="text-center">
              ...
              <div className="bg-primary/10 border border-primary/20 rounded-lg p-6 mb-6">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <Button onClick={handleRedirect} disabled={isRedirecting} className="flex-1 bg-green-600 hover:bg-green-700">
                    <WhatsAppIcon />
                    {isRedirecting ? "Redirecionando..." : "Falar no WhatsApp"}
                  </Button>
                  {receiptUrl && <Button asChild variant="outline" className="flex-1">
            ...
            <div className="border-t pt-6 space-y-4">
              ...
              <ol className="space-y-3 text-sm text-muted-foreground">
                ...
                <li className="flex gap-3">
                  ...
                  <span>Siga as instruções para solicitar corretamente seu exame</span>
                </li>
                <li className="flex gap-3">
                  ...
                  <span>Você receberá a solicitação médica do exame</span>
                </li>
              </ol>
            </div>
