...
export default function SolicitacaoExames() {
  ...
  const servico = CATALOGO_SERVICOS.find(s => s.slug === 'solicitacao_exames');
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Peça seus exames de forma prática: solicitação médica online, assinada digitalmente e aceita em qualquer laboratório, sem sair de casa.
              </p>
              ...
              {/* Como funciona - EXCLUSIVO DA PÁGINA SOLICITAÇÃO EXAMES */}
              <div className="mb-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-4">
                    <div className="w-8 h-8 bg-primary text-primary-foreground rounded-full flex items-center justify-center font-semibold text-sm flex-shrink-0">4</div>
                    <div>
                  ...
                  <div className="flex gap-4">
                    <div className="w-8 h-8 bg-primary text-primary-foreground rounded-full flex items-center justify-center font-semibold text-sm flex-shrink-0">5</div>
                    <div>
