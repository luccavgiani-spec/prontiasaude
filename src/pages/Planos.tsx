...
const Planos = () => {
  ...
  return <>
      ...
      {/* Subscription Modal */}
      {selectedPlan && <PaymentModal open={isPaymentModalOpen} onOpenChange={setIsPaymentModalOpen} sku={selectedPlan.sku} serviceName={selectedPlan.name} amount={selectedPlan.amount} recurring={selectedPlan.recurring} frequency={selectedPlan.frequency} frequencyType={selectedPlan.frequencyType} onSuccess={() => {
