...
export const CATALOGO_SERVICOS = [
  ...
  { 
    ...
    precoBase: 89.90, 
    sku: "TQP5720",
    descricao: "Pediatria, Cardiologia, Ginecologia, Dermatologia, Gastroenterologia, Otorrinolaringologia, Ortopedia, Oftalmologia, Endocrinologia, Psiquiatria, Urologia, Neurologia, Nutrologia, Infectologia, Imunologia, Médico da Família, Geriatria, Reumatologia, Proctologia, Pneumologia, Nutrição, Personal Trainer",
    tempo: "30-60 minutos",
    inclui: [
      "Pediatria", "Cardiologia", "Ginecologia", "Dermatologia",
      "Gastroenterologia", "Otorrinolaringologia", "Ortopedia",
      "Oftalmologia", "Endocrinologia", "Psiquiatria",
      "Urologia", "Neurologia", "Nutrologia",
      "Infectologia", "Imunologia", "Médico da Família",
      "Geriatria", "Reumatologia", "Proctologia",
      "Pneumologia", "Nutrição", "Personal Trainer"
    ],
    variantes: [
      { valor: 89.90, nome: "Pediatria", sku: "HMG9544" },
      { valor: 89.90, nome: "Cardiologia", sku: "TQP5720" },
      { valor: 89.90, nome: "Ginecologia", sku: "CCP1566" },
      { valor: 89.90, nome: "Dermatologia", sku: "HGG3503" },
      { valor: 89.90, nome: "Gastroenterologia", sku: "TSB0751" },
      { valor: 89.90, nome: "Otorrinolaringologia", sku: "HME8366" },
      { valor: 89.90, nome: "Ortopedia", sku: "TVQ5046" },
      { valor: 89.90, nome: "Oftalmologia", sku: "FKS5964" },
      ...
      { valor: 119.90, nome: "Neurologia", sku: "PKS9388" },
      { valor: 119.90, nome: "Nutrologia", sku: "LZF3879" },
      { valor: 119.90, nome: "Infectologia", sku: "MYX5186" },
      { valor: 119.90, nome: "Imunologia", sku: "IMU4471" },
      { valor: 119.90, nome: "Médico da Família", sku: "DYY8522" },
      { valor: 119.90, nome: "Geriatria", sku: "YZD9932" },
      { valor: 129.90, nome: "Reumatologia", sku: "UDH3250" },
      { valor: 129.90, nome: "Proctologia", sku: "PRC6621" },
      { valor: 139.90, nome: "Pneumologia", sku: "PNE7783" },
