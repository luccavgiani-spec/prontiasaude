          ...
          <div className="flex justify-center mb-8">
            <div className="inline-block bg-muted/50 rounded-2xl p-1.5">
              <div className="flex gap-1">
                {duracoes.map(duracao => <button key={duracao.meses} onClick={() => setDuracaoSelecionada(duracao.meses)} className={`relative px-4 py-2 rounded-xl text-sm font-medium transition-all ${duracaoSelecionada === duracao.meses ? "bg-green-600 text-white" : "bg-white text-green-700 border border-green-600 hover:bg-green-50"}`}>
                    {duracao.label}
