              ...
              <div className="relative">
                ...
                <div className="relative bg-card border rounded-3xl p-8 shadow-xl">
                  <div className="text-center">
                    ...
                    <h3 className="text-2xl font-bold mb-2">ClubeBen</h3>
                    <p className="text-sm text-muted-foreground mb-6">
                      Seu clube de benefícios Prontia Saúde
                    </p>
                    
                    <div className="space-y-3">
                      <div className="flex items-center justify-between p-3 bg-primary/5 rounded-lg">
                        <span className="text-sm font-medium">Farmácias</span>
                        <span className="text-sm font-bold text-primary">Até 80%</span>
                      </div>
                      <div className="flex items-center justify-between p-3 bg-primary/5 rounded-lg">
                        <span className="text-sm font-medium">Exames</span>
                        <span className="text-sm font-bold text-primary">Descontos especiais</span>
                      </div>
                      <div className="flex items-center justify-between p-3 bg-primary/5 rounded-lg">
                        <span className="text-sm font-medium">Fitness</span>
                        <span className="text-sm font-bold text-primary">Vantagens exclusivas</span>
                      </div>
                    </div>
                  </div>
                </div>
