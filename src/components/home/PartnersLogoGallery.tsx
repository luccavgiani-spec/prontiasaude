...
const partnerLogos = [
  ...
  { id: 'netshoes', src: netshoesLogo, alt: 'Netshoes', fullFill: true, bgClass: 'bg-netshoes' },
  ...
  { id: 'drogasil', src: drogasilLogo, alt: 'Drogasil', fullFill: true, bgClass: 'bg-drogasil' },
